...
ec= commands.getstatusoutput("sudo  virt-install  --vnc --vnclisten=192.168.91.130 --vncport="+ port +"  --noautoconsole --name  os"+ port2 +" --ram "+ ram +" --vcpu "+ cpu +" --disk path=/var/lib/libvirt/images/newos.qcow2,size="+hd+" --cdrom /ubuntu.iso")
